...
/*
   使用済：C:\Users\tktomaru\AppData\Local\Arduino15\packages\esp32\hardware\esp32\1.0.1\libraries\SD
  未使用：D:\Soft2\arduino-nightly-windows\arduino-1.8.6\libraries\SD
  次のフォルダのライブラリBLEバージョン1.0.1を使用中：C:\Users\tktomaru\AppData\Local\Arduino15\packages\esp32\hardware\esp32\1.0.1\libraries\BLE
  次のフォルダのライブラリSPIバージョン1.0を使用中：C:\Users\tktomaru\AppData\Local\Arduino15\packages\esp32\hardware\esp32\1.0.1\libraries\SPI
  次のフォルダのライブラリTFT_eSPI-masterバージョン1.4.8を使用中：C:\Users\tktomaru\Documents\Arduino\libraries\TFT_eSPI-master
  次のフォルダのライブラリFSバージョン1.0を使用中：C:\Users\tktomaru\AppData\Local\Arduino15\packages\esp32\hardware\esp32\1.0.1\libraries\FS
  次のフォルダのライブラリSPIFFSバージョン1.0を使用中：C:\Users\tktomaru\AppData\Local\Arduino15\packages\esp32\hardware\esp32\1.0.1\libraries\SPIFFS
  次のフォルダのライブラリSDバージョン1.0.5を使用中：C:\Users\tktomaru\AppData\Local\Arduino15\packages\esp32\hardware\esp32\1.0.1\libraries\SD
  次のフォルダのライブラリTimeバージョン1.5を使用中：C:\Users\tktomaru\Documents\Arduino\libraries\Time
  次のフォルダのライブラリArduinoJson-masterバージョン5.13.4を使用中：C:\Users\tktomaru\Documents\Arduino\libraries\ArduinoJson-master
  次のフォルダのライブラリNTPClient-masterバージョン3.1.0を使用中：C:\Users\tktomaru\Documents\Arduino\libraries\NTPClient-master
  次のフォルダのライブラリWiFiバージョン1.0を使用中：C:\Users\tktomaru\AppData\Local\Arduino15\packages\esp32\hardware\esp32\1.0.1\libraries\WiFi
  次のフォルダのライブラリZackertバージョン0.0.1を使用中：C:\Users\tktomaru\Documents\Arduino\libraries\Zackert
  次のフォルダのライブラリWireバージョン1.0.1を使用中：C:\Users\tktomaru\AppData\Local\Arduino15\packages\esp32\hardware\esp32\1.0.1\libraries\Wire
  次のフォルダのライブラリBME280-I2C-ESP32-masterバージョン1.1を使用中：C:\Users\tktomaru\Documents\Arduino\libraries\BME280-I2C-ESP32-master
*/
